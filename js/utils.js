...
var AppUtils = window.AppUtils || {
    ...
    getTeamLogo(teamName) {
        ...
        const map = {
            ...
            'atlético de madrid': 'escudos/primera/ATLÉTICO_MADRID-150x150.png?v=3',
            'at. madrid': 'escudos/primera/ATLÉTICO_MADRID-150x150.png?v=3',
            'atlético': 'escudos/primera/ATLÉTICO_MADRID-150x150.png?v=3',
