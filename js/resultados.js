...
class ResultsManager {
    ...
    calculateAndRender() {
        ...
        theadHtml += `<tr><th class="col-temporada" style="z-index:3; padding:8px 4px; color:var(--resultados-header-text); line-height:1.2; text-align:center;">Temporada<br>2026-2027</th>`;
